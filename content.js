...
let spaceMarinesVsOrksQuestions = [
    {
        ...
        choiceTwoPower: 15,
        choiceThree: 'Organise rapid strike forces to preemptively attack the Orks before their numbers can grow.', choiceThreePower: 20,
    },
    {
    ...
    { 
        question: 'The Orks have pushed us back and are now attacking the planetary capital with all their might.', questionPower: 60, 
    ...
    { 
        question: 'The Orks have broken through our lines in multiple areas how do we counter this threat?', questionPower: 80, 
        choiceOne: 'Engage them in melee to slow them down and allow us to reform the line with our reserves.', choiceOnePower: 50, 
        choiceTwo: "Pull back inside the city and allow the city's automated defences to thin the horde.", choiceTwoPower: 60, 
...
let adMechVsOrksQuestions = [
    { 
        question: 'Ork activity has been reported in the more uninhabited parts of the planet. What is the first step we should take?', 
        questionPower: 20, 
        choiceOne: 'Study past conflicts with the Orks and determine what strategy would be best used to defeat them', choiceOnePower: 20, 
    ...
    { 
    question: 'The Orks have pushed us back and are now attacking the planetary capital with all their might.', questionPower: 60, 
    choiceOne: 'Give local command to the Skitarii captains they will best know how to organise the troops', choiceOnePower: 40, 
    choiceTwo: 'Use your tanks and other heavy vehicles to whittle down their numbers as your Skitarii fall back.', choiceTwoPower: 30, 
    ...
    choiceOnePower: 70, 
    choiceTwo: 'Launch a spearhead into the enemy lines with the imperial knights aim right for the Warboss.', choiceTwoPower: 80, 
...
let guardVsOrksQuestions = [
    ...
    question: 'Ork activity has been reported in the more uninhabited parts of the planet. What is the first step we should take?', 
    questionPower: 20, 
    choiceOne: 'Start conscripting the local population all people will be needed to hold back the Orks.', choiceOnePower: 10, 
    ...
    choiceOnePower: 10, 
    choiceTwo: 'Use all air power to destroy the Orks it is already too late to save those in the settlements', choiceTwoPower: 15, 
...
    { 
    question: 'The Ork Warboss has been seen on the battlefield leading his horde. Eliminating him will cause the Orks to scatter and end the battle.', 
    questionPower: 100, 
    choiceOne: 'Charge the Warboss with our mutant Ogryn their massive guns and strength will wear him down.', choiceOnePower: 75, 
...
let spaceMarinesVsChaosQuestions = [
    ...
    choiceTwoPower: 10, 
    choiceThree: 'Purge all icons and idols and kill anyone who gets in our way, this heresy will not stand!', choiceThreePower: 5, 
    },
    { 
    ...
    choiceOnePower: 20, 
    choiceTwo: 'Clear out the barricades and eliminate the cultist leaders, they will not stand a chance.', choiceTwoPower: 25, 
    ...
    choiceTwoPower: 30, 
    choiceThree: 'Organise your troops into assault teams and cut down the enemy while they are landing.', choiceThreePower: 40, 
    },
    { 
    ...
    questionPower: 80, 
    choiceOne: 'Locate the source of the daemons and destroy it, the longer we leave the rift open more daemons will come.', choiceOnePower: 50, 
    ...
    choiceTwoPower: 50, 
    choiceThree: 'Split your forces, there is no choice if we let our defences lapse anywhere we will surely fall.', choiceThreePower: 60, 
    },
    { 
...
let adMechVsChaosQuestions = [
    ...
    question: 'Daemons attack the city from the inside while the Chaos Spacemarines are assaulting the walls which will not hold for long.', 
    questionPower: 80, 
    choiceOne: 'Destroy the lower areas of the city, maybe the destruction will stem the flow of daemons then we can focus on the main Chaos Spacemarine attack.', choiceOnePower: 50, 
    ...
    choiceOnePower: 70, 
    choiceTwo: 'Fight for every inch of ground, our weapons are superior and we follow the Omnisiaas will.', choiceTwoPower: 60, 
...
let guardVsChaosQuestions = [
    ...
    question: 'On arrival to the planetary capital it is obvious something is not right. The populace are restless, many strange icons and idols adore the buildings in the lower part of the city. Bands of hooded men are roaming the streets chanting foul incantations and there have been clashes with local defence forces.', 
    questionPower: 20, 
    choiceOne: 'Integrate your troops with the local defence forces and increase number of patrols and shakedowns of these areas.', choiceOnePower: 10, 
    choiceTwo: 'Sanction local priests to enter the areas, their sermons and religious fervor shall settle the people.', choiceTwoPower: 10, 
    choiceThree: 'Keep your troops out of these "corrupted" areas and make sure key personal and facilities are defended', choiceThreePower: 5, 
    },
    { 
    question: 'The clashes have become full blown riots, whole sections of the city have been barricaded and heads of local leaders adorn spikes.', 
    questionPower: 40, 
    ...
    choiceTwoPower: 50, 
    choiceThree: 'Amass troops at strong points throughout the city there are already to many of them.', choiceThreePower: 40, 
    },
    { 
    question: 'Daemons attack the city from the inside while the Chaos Spacemarines are assaulting the walls which will not hold for long.', 
    questionPower: 80, 
    ...
    choiceTwoPower: 60, 
    choiceThree: 'Call forth our Super Heavy tanks, Baneblades to smash the Chaos Spacemarines assault', choiceThreePower: 70, 
    },
    { 
    question: 'The Chaos Spacemarines have broken through our defences but their numbers are low our final stand will determine the outcome of the battle!', 
    questionPower: 100, 
...
let spaceMarinesVsTyranidsQuestions = [
    ...
    questionPower: 20, 
    choiceOne: 'Begin a scorched earth campaign, destroy all organic life outside of the planetary capital leaving nothing for the tyranids to feed on.', choiceOnePower: 20, 
    ...
    questionPower: 80, 
    choiceOne: 'Send all Dreadnaughts to the main gate, together they may be able to bring down the Carnifex', choiceOnePower: 70, 
    choiceTwo: 'Bring the creature down with well aimed heavy weapons fire before it can reach the gate.', choiceTwoPower: 60, 
    ...
    choiceOnePower: 80, 
    choiceTwo: 'Blast the creature with every heavy weapon you have left it will not stand against the Imperiums might!', choiceTwoPower: 70, 
    choiceThree: 'Draw the Hive Tyrant deeper into the city and ambush it with your remaining Spacemarines.', choiceThreePower: 50, }]
...
let adMechVsTyranidsQuestions = [
    ...
    choiceOnePower: 20, 
    choiceTwo: 'Send out maniples of servitors to destroy the Gaunts with a mixture of heavy weapons and explosives.', choiceTwoPower: 20, 
    ...
    choiceTwoPower: 60, 
    choiceThree: 'Have your Skitarii vanguard deploy to the gate their rapidfire radiation weapons will ruin the tyranid attack', choiceThreePower: 50, 
    },
    { 
    question: 'We are losing the battle, but we have a chance the hive tyrant is the source of the tyranids synapse. If we destroy it the remaining tyranids will lose all cohesion!', 
    questionPower: 100, 
    ...
    choiceTwoPower: 80, 
    choiceThree: 'Take control of the Skitarii and remaining vehicles still alive you skills and knowledge will put them to best use', choiceThreePower: 80, 
    }]
...
let guardVsTyranidsQuestions = [
    ...
    choiceOnePower: 10, 
    choiceTwo: 'Create hard points throughout the planet, the only way to defeat this enemy is to divide its might.', choiceTwoPower: 5, 
...
    { 
    ...
    choiceOnePower: 70, 
    choiceTwo: 'Send in your Ogryns to hold the gate their strength and sheer fortitude will allow us to reorganise.', choiceTwoPower: 60, 
